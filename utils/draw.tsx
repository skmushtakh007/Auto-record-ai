...
// it will draw red box around  detected person
export function drawOnCanvas(
  ...
  predictions.forEach((detectedObject: DetectedObject) => {
    ...
    if (ctx) {
      ...
      // check mirrod or not for detection
      mirrored
      ...
      ctx.globalAlpha = 1;
      mirrored
        ? ctx.fillText(name, ctx.canvas.width - x  -width + 10, y + 20) // to handle name on box while changing orientation
